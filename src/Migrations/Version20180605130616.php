 ...
 */
class Version20180605130616 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE student (id INT AUTO_INCREMENT NOT NULL, group_id INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, face VARCHAR(255) DEFAULT NULL, encoding LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', shadow TINYINT(1) NOT NULL, INDEX IDX_B723AF33FE54D947 (group_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
